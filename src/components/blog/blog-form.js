...
export default class BlogForm extends Component {
  constructor(props) {
    ...
    this.state = {
      ...
      featured_image: "",
      apiUrl:
        "https://thomasdigregorio.devcamp.space/portfolio/portfolio_blogs",
      apiAction: "post",
    };
  ...
  UNSAFE_componentWillMount() {
    if (this.props.editMode) {
      this.setState({
        ...
        apiUrl: `https://thomasdigregorio.devcamp.space/portfolio/portfolio_blogs/${this.props.blog.id}`,
        apiAction: "patch",
      });
    }
  }
